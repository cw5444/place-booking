  ...
  return (
    ...
    >
      ...
      <div
        style={{
          display: "grid",
          // ✅ 2열일 때 오른쪽(시간 선택)의 최소 폭을 보장해서 "찌그러짐" 방지
          // ✅ 폭이 부족하면 위의 isMobile(960)로 1열로 떨어짐
        ...
        <div style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 12, minWidth: 0 }}>
          ...
          <Calendar
            ...
            tileContent={({ date: tileDate, view }) => {
              ...
              return (
                <div style={{ marginTop: 2, width: "100%", display: "flex", justifyContent: "center", pointerEvents: "none" }}>
